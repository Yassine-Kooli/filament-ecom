                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="font-semibold">{{ Number::currency($price_range) }}</div>
                            <input type="range" wire:model.live="price_range"
                                ...
                                max="10000" value="5000" step="10">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(10)}}</span>
                                ...
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        <div class="flex items-center justify-between gap-2 mb-2">
                                            <h3 class="text-xl font-medium dark:text-gray-400 truncate" style="height: 2.5rem; overflow: hidden;"
>
                                                {{ $product->name }}
                                            </h3>
                                        </div>
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a wire:click.prevent='addToCart({{ $product->id }})' href="#"
                                            ...
                                            </svg><span>Add to Cart</span><span wire:loading wire:target='addToCart({{ $product->id }})'>Adding...</span>
                                        </a>
